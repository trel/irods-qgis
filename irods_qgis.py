...
# making sure python irods client is imported from the current working directory
import sys
import os
...
class irods_qgis:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('irods_qgis', message)
